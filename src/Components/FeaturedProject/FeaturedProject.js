        ...
        <>
            <div className="max-w-2xl mx-auto py-4 px-4 grid grid-cols-1 gap-y-16
                ...
                <div>
                    ...
                    <div className="mt-2">
                        <ImageTechBadge text={"C#"}
                                        src={"https://cdn.jsdelivr.net/gh/devicons/devicon/icons/csharp/csharp-original.svg"}/>
                        <ImageTechBadge text={"XAML"}/>
                        <ImageTechBadge text={".Net Core"}
                                        src={"https://cdn.jsdelivr.net/gh/devicons/devicon/icons/dotnetcore/dotnetcore-original.svg"}/>
                        <ImageTechBadge text={"SQL"}
                    ...
                    <div className="mt-4">
                        ...
                        <p className="text-gray-300">
                            The software was built from the ground up to make it as easy as possible to track a high
                            level
                            of data with minimal input from the user while playing. The idea is that you will create (or
                            import
                            someone else's) pre-made tournament templates and then use those templates when you sit down
                            to play to quickly
                            start tournaments. The templates contain all the information for the tournament such as
                            name, buy-in,
                            start time, starting stack sizes, blind levels, late registration length, and much more. The
                            user just
                            has to enter the few variables that change every night such as number of players registered,
                            finishing
                    ...
                    <div className="mt-4">
                        ...
                        <p className="text-gray-300">
                            ...
                            framework to run on Windows, Mac, and Linux systems. The software was developed by one
                            person
                            ...
                            components. The data is managed by a backend SQL database using entity framework for the
                            ORM.
                            Tournament Life was built from the start up to fully conform to the MVVM architectural
                            pattern.
            ...
            <div className="h-4/5">
                {isShowing && (<ImageModal imageSrc={modalSource} title={title} description={description}
                                           setClosed={setIsShowing}/>)}
            </div>
        </>)
}